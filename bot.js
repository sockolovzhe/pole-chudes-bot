...
const db = new Database(`mongodb://${process.env.MONGO_ADMIN}:${process.env.MONGO_PASSWORD}@${process.env.MONGO_HOST}:${process.env.MONGO_HOST}/pole-chudes-bot?authSource=admin`);
