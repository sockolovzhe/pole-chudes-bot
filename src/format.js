...
const START_TEXT =
  ...
  '🤵 Ведущему: начните игру командой /newgame и загадайте слово кнопками — ' +
  '«🎲 Сгенерировать загадку» (AI придумает загадку по праздникам дня) или ' +
  '«✍️ Загадать своё слово» (бот спросит слово, вопрос, картинку и время старта).\n\n' +
  '📋 Команды для игроков:\n' +
  ...
  '/history - История игр с оценками слов\n' +
...
const HELP_TEXT =
  ...
  '🤵 Для ведущего:\n' +
  '/newgame - Начать новую игру (вы станете ведущим); слово загадывается кнопками под сообщением\n' +
  '/end - Завершить игру\n' +
  '/cancelstart - Отменить отложенный старт игры\n' +
  ...
  '/status - Текущее состояние игры\n' +
  '/stats - Статистика чата\n' +
  '/history - История всех игр с оценками слов\n' +
  '/words - Рейтинг слов по сложности\n\n' +
  '⏰ Старт игры можно отложить: после выбора слова бот спросит время (ЧЧ:ММ по Екатеринбургу ' +
  'или «сейчас») — загадка сама придёт в чат в назначенный момент.\n\n' +
  '💡 При правильном ответе ваш ход продолжается, при ошибке - ход переходит следующему.';
